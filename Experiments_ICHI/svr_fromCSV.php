...
if($argv[5] == 1)
{
$pd = getDataPartitioned($data_full,$fold, false);
}
else
{
...
writeCSVData('results\\ls_'.$year.'_'.$district.'.csv', $accuracy);
...
writeCSVData('results\\ensemble_'.$year.'_'.$district.'.csv', $accuracyEnsemble);
...
writeCSVData('results\\FinalEnsemble.csv', $final_results_ensemble);
